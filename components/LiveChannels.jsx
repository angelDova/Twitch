  ...
  return (
    <div id="live" className="p-2 md:p-8">
      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-3 2xl:grid-cols-4 3xl:grid-cols-5 gap-4 py-2">
        <LiveChannelItem
          img={Live1}
          profile_img="https://static-cdn.jtvnw.net/jtv_user_pictures/nadeshot-profile_image-117d4d07e78d767a-50x50.png"
        ...
        <LiveChannelItem
          img={Live3}
          profile_img="https://static-cdn.jtvnw.net/jtv_user_pictures/6d33fe59-3b61-4c65-b6bc-fe1e5fea3062-profile_image-50x50.png"
        ...
        <LiveChannelItem
          img={Live7}
          profile_img="https://static-cdn.jtvnw.net/jtv_user_pictures/6238d899-d8a5-4bd7-abf5-75904f020776-profile_image-50x50.png"
